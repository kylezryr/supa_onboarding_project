...
function Questions({
  ...
  const getQuestions = async () => {
    ...
    try {
      fetch(
        `http://18.140.246.157:9000/lessonID/${params.type}/${params.difficulty}/${params.level}/${params.lesson}`,
      )
        .then((response) => {
        ...
        .then((data) => {
          ...
          fetch("http://18.140.246.157:9000/questions/" + receivedLessonID)
            .then((response) => {
              return response.json();
            })
            .then((data) => {
          ...
          fetch("http://18.140.246.157:9000/lesson/" + receivedLessonID)
            .then((response) => {
              return response.json();
            })
            .then((data) => {
  ...
  const updateLessonScore = async () => {
    try {
      fetch(
        `http://18.140.246.157:9000/rankID/${params.type}/${params.difficulty}/${params.level}`,
      )
        .then((response) => {
          return response.json();
        })
        .then((data) => {
          ...
          fetch(
            `http://18.140.246.157:9000/updateLessonScore/${lessonID}/${pointsScored}/${receivedRankID}`,
            {
              method: "POST",
            },
          ).then((response) => {
