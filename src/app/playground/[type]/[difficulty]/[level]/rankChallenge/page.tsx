...
function RankChallenge({
    ...
    try {
      ...
      fetch(
        ...
        .then((data) => {
          ...
          fetch(`http://18.140.246.157:9000/challengeQuestions/${receivedRankID}`)
            .then((response) => {
              return response.json();
            })
            .then((data) => {
          ...
          fetch(`http://18.140.246.157:9000/scores/${receivedRankID}`)
            .then((response) => {
              return response.json();
            })
            .then((data) => {
  ...
  const updateRankChallenge = async () => {
    if (rankChallengePassed) {
      try {
        fetch(`http://18.140.246.157:9000/updateRank/${rankID}`, {
          method: "POST",
        }).then((response) => {
