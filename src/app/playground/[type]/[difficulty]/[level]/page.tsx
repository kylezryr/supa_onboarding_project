...
function Lessons({
  ...
  const getLessons = async () => {
    try {
      fetch(
        "http://18.140.200.64:9000/rankID/" +
          params.type +
          "/" +
          params.difficulty +
          "/" +
        ...
        .then((data) => {
          ...
          setRankID(rankID);
          fetch("http://18.140.200.64:9000/lessons/" + rankID)
            .then((response) => {
              return response.json();
            })
            .then((data) => {
    ...
    try {
      fetch(
        ...
        .then((data) => {
          const rankID = data[0].id;
          setRankID(rankID);
          fetch("http://18.140.200.64:9000/showRankChallenge/" + rankID)
            .then((response) => {
              return response.json();
            })
            .then((data) => {
          ...
          if (
            ...
            fetch("http://18.140.200.64:9000/nextRank/" + rankID)
              .then((response) => {
                return response.json();
              })
              .then((data) => {
